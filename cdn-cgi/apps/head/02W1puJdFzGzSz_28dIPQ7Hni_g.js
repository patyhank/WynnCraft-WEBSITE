;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="d901763d41895b2d4ce6d1459d43aa87";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["TosAhdMAKLKO"]={appId:"XzVIEqe1R2kW",scope:{}};;CloudflareApps.installs["TosAhdMAKLKO"].options={"ie":9};;CloudflareApps.installs["ov2FMZ0s8wMl"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["ov2FMZ0s8wMl"].options={"account":{"accountId":"s9mXE0YULCmn","service":"googleanalytics","userId":"116906962965413681586"},"domain":"","id":"UA-39147299-1","showDomain":false};;if(CloudflareApps.matchPage(CloudflareApps.installs['ov2FMZ0s8wMl'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['ov2FMZ0s8wMl'].URLPatterns)){(function(){var options=CloudflareApps.installs['ov2FMZ0s8wMl'].options
var domain=options.showDomain&&options.domain?options.domain:'auto'
if(!options.id)return
window.ga('create',options.id,domain)
window.ga('send','pageview')}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/0ulb80QNgeZzzE-wC_83cXTLaoE.js';document.head.appendChild(script);})();