...
function startFunc(e,t){e(),setInterval(e,t)}$=jQuery=require("jquery"),require("./ext/bootstrap.min"),require("./ext/jquery.dataTables.min"),require("./ext/jquery.smoothscroll.min"),require("./ext/baseTemplate");var config=require("./publicConfig.json");$(document).ready(function(){function e(e){var t=3;$(e).find("item").each(function(){t>0&&$("#news-feed").append('<article class="newspost content-container"><div class="content-inner"><h3 class="newspostheader"><a href="'+$(this).find("link").text()+'">'+$(this).find("title").text()+'</a></h3><div class="newspostauthor">Posted by '+$(this).find("dc\\:creator, creator").text()+'</div><div class="newspostcontent">'+$(this).find("content\\:encoded, encoded").text()+" </div>("+$(this).find("slash\\:comments, comments").text()+" Comments)</div></article>"),t--})}var t=setInterval(function(){var e=$("iframe#twitter-widget-0");0!=e.length&&0!=e.contents().find(".TweetAuthor-screenName").length&&(e.contents().find(".TweetAuthor-screenName").css("color","#321F19"),e.contents().find(".timeline-Tweet-retweetCredit").css("color","#321F19"),clearInterval(t))},100);startFunc(function(){$.ajax({type:"GET",url:config.url.api+"public_api.php?action=onlinePlayersSum",dataType:"json",success:function(e){$(".plycount").text(e.players_online)}})},1e3*config.playerCount.refresh),console.info("Querying for playercount every "+config.playerCount.refresh+"s"),$("body").scrollspy({target:".navbar-fixed-top"}),$("#nav").smoothScroll(1e3),console.info("Smooth Scrolling for jQuery (c) mathiasbynens loaded..."),"#about"==window.location.hash&&($("#aboutModal").modal(),console.info("Looks like this is an about page firing modal ASAP...")),$(".about").click(function(){$("#aboutModal").modal("show")}),$.ajax({type:"GET",url:config.url.api+"news.php",dataType:"xml",success:e}),console.info("Homepage core loaded...")});
