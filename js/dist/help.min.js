...
console.info("Initialising core JavaScript..."),$("[data-toggle=tooltip]").tooltip(),console.info("Tooltips fired..."),function(o){var n=o(window).width();o(document).on("show.bs.modal",function(){n<o(window).width()&&o("body.modal-open,.navbar-fixed-top,.navbar-fixed-bottom").css("marginRight",o(window).width()-n)}),o(document).on("hidden.bs.modal",function(){o("body,.navbar-fixed-top,.navbar-fixed-bottom").css("marginRight",0)}),o(document).resize(function(){n=o(window).width()})}(jQuery),console.info("Bootstrap 3 modal hacks done..."),$(document).ready(function(){try{ZeroClipboard.config({swfPath:"/js/ZeroClipboard.swf"});new ZeroClipboard(document.getElementById("ipImage")).on("ready",function(o){console.info("Setup SWF for IP copy button")})}catch(o){}});
